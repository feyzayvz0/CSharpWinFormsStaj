...
{
    public class GooseService(IGooseRepository gooseRepository, IProductRepository productRepository, ICashRepository cashRepository)
    {
        private readonly IGooseRepository _gooseRepository = gooseRepository;
